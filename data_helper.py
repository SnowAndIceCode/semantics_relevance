...
class PairwiseDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Mask 部分单词用于 MLM 任务
        mlm_neg_input_ids, neg_input_ids,neg_labels = self.mask_tokens(neg_input_ids)
        mlm_posi_input_ids,posi_input_ids, posi_labels = self.mask_tokens(posi_input_ids)

        return mlm_neg_input_ids,mlm_posi_input_ids,neg_input_ids,posi_input_ids,neg_attention_mask,posi_attention_mask, neg_token_type_ids,posi_token_type_ids,neg_labels,posi_labels
