...
from transformers import BertForMaskedLM,BertPreTrainedModel,BertModel,BertConfig,BertForSequenceClassification
...
if __name__ == '__main__':
    ...
    # model = BertForSequenceClassification.from_pretrained(mode_path)
    data = ['你好','你是谁']
