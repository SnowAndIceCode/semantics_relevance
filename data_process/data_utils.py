...
if __name__ == '__main__':
    print('保持好心情！ ')
    file_a = '/Users/a58/Documents/wxb/workspace/semantics_relevance/data_process/ctrs_leval/test.csv'
    file_b = '/Users/a58/Documents/wxb/workspace/semantics_relevance/data_process/post-pretrain-data/post_tuning_q2q_soft.csv'
    save_path = '../dataset/ctrs+q2q.csv'
